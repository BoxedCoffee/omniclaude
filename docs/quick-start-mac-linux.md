# OmniClaude Quick Start for macOS and Linux
...
## 6. Updating OmniClaude

```bash
npm install -g @boxedcoffee/omniclaude@latest
```

## 7. Uninstalling OmniClaude

```bash
npm uninstall -g @boxedcoffee/omniclaude
```
