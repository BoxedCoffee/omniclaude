# OmniClaude for Non-Technical Users
...
## What OmniClaude Does

OmniClaude lets you use an AI coding assistant with different model providers such as:
...
After you run `omniclaude`, the CLI should start and wait for your prompt.
