...
OmniClaude is a fast-moving open-source coding-agent CLI with support for multiple providers, local backends, MCP, and a terminal-first workflow. The best contributions here are focused, well-tested, and easy to review.

## Before You Start

- Search existing [issues](https://github.com/BoxedCoffee/omniclaude/issues) and [discussions](https://github.com/BoxedCoffee/omniclaude/discussions) before opening a new thread.
...
OmniClaude supports multiple provider paths. If you change provider logic:
