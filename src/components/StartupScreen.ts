/**
 * OmniClaude startup screen — filled-block text logo with sunset gradient.
 * Called once at CLI startup before the Ink UI renders.
 *
 * Addresses: https://github.com/BoxedCoffee/omniclaude/issues/55
 */
...
const ACCENT: RGB = [255, 212, 88]
const CREAM: RGB = [236, 232, 255]
const DIMCOL: RGB = [148, 140, 196]
const BORDER: RGB = [112, 94, 186]
...
export function printStartupScreen(): void {
  ...
  out.push(`${rgb(...BORDER)}\u255a${'\u2550'.repeat(W - 2)}\u255d${RESET}`)
  out.push(`  ${DIM}${rgb(...DIMCOL)}omniclaude ${RESET}${rgb(...ACCENT)}v${MACRO.DISPLAY_VERSION ?? MACRO.VERSION}${RESET}`)
  out.push('')
