# OmniClaude Local Agent Playbook

This playbook is a practical guide to run OmniClaude with a local model (Ollama), work safely, and get strong day-to-day results.
...
If everything is healthy, OmniClaude starts directly.
...
Or let OmniClaude recommend the best local model for your goal:
